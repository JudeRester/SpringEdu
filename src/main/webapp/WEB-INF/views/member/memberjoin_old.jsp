...
<form:form modelAttribute="memberVO" action="/member/memberJoinOK" method="post" class="form-row">

  <div class="form-group">
    <label for="id" class="control-label cols-sm-2">아이디</label>
    	<div class="cols-sm-10">
	    	<div class="input-group"><span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
			    <form:input path="id" class="form-control" aria-describedby="emailHelp" placeholder="ex)abcd@mail.com"/>
  ...
  <div class="form-group">
    <label for="passwd" class="control-label cols-sm-2">비밀번호</label>
    <div class="cols-sm-10">
		<div class="input-group">
			<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
    		<form:password path="passwd" class="form-control col-md-6" placeholder="숫자, 문자, 특수문자 조합"/>
    		<form:errors path="passwd" cssClass="errmsg"/>
  		</div>
  	</div>
  </div>
  <div class="form-group">
  	<label for="password" class="control-label cols-sm-2" >비밀번호 확인</label>
	<input type="password" name="password" class="form-control col-md-6" placeholder="비밀번호를 확인해주세요"/>  
	<span class="passErr"></span>
  </div>
  <div class="form-group col-md-4">
  	<form:label path="name">이름</form:label>
  	<form:input path="name" class="form-control col-md-4" />
  	<form:errors path="name" cssClass="errmsg"/>
  </div>
  <div class="form-group">
  	<form:label path="birth">생년월일</form:label>
  	<form:input class="form-control" path="birth" placeholder="ex)19940307" />
